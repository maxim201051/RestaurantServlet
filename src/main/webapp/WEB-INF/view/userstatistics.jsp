                ...
                <table>
                    ...
                    <tr>
                        <c:forEach var="user" items="${pageContext.request.getAttribute('users')}">
                            ...
                            <td><span><fmt:formatDate value="${user.registrationDate}" pattern="'dd-MM-yyyy'"/></span>
                            </td>
                            <td>
                                <a href="${pageContext.request.contextPath}/admin/concreteuserstatistic?id=${user.id}">
