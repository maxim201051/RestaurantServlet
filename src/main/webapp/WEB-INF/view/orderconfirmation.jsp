            ...
            <div class="table">
                <table>
                    ...
                    <tr>
                        ...
                        <th><fmt:message key="orderconfirmatiom.button.accept"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <c:if test="${pageContext.request.getAttribute('orders').isEmpty()}">
                            <td colspan="6"><fmt:message key="orderconfirmation.label.noOrders"/></td>
                        </c:if>
                    </tr>
                    <tr>
                        <c:forEach var="order" items="${pageContext.request.getAttribute('orders')}">
                            ...
                            <td><a href="${pageContext.request.contextPath}/admin/acceptorder?id=${order.id})">
                                <fmt:message key="orderconfirmatiom.button.accept"/>
                            </a></td>
                        </c:forEach>
                    </tr>
                    </tbody>
